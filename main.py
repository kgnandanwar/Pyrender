...
# Fuze trimesh
fuze_trimesh = trimesh.load('./pyrender_files/examples/models/fuze.obj')
fuze_mesh = Mesh.from_trimesh(fuze_trimesh)

# Drill trimesh
drill_trimesh = trimesh.load('./pyrender_files/examples/models/drill.obj')
...
# Wood trimesh
wood_trimesh = trimesh.load('./pyrender_files/examples/models/wood.obj')
wood_mesh = Mesh.from_trimesh(wood_trimesh)

# Water bottle trimesh
bottle_gltf = trimesh.load('./pyrender_files/examples/models/WaterBottle.glb')
